				...
				<div class="tab_container">
					<div id='tab1' class="tab_content pd0">
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="title" id="param_name" _autocheck="true" type="text" onkeyup="ChangeToAlias();" value="<?php echo $blog->title; ?>" /></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<textarea name="intro" id="param_intro" class="editor"><?php echo $blog->intro; ?></textarea>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<textarea name="content" id="param_content" class="editor"><?php echo $blog->content; ?></textarea>
