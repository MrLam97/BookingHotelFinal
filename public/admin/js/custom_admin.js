...
(function($)
{
	$(document).ready(function()
	{
		...
		// Lấy id thanh pho
		$('#param_provinces').change(function(){
...
function ChangeToAlias()
{
    ...
    title = document.getElementById("param_name").value;
    ...
    alias = '@' + alias + '@';
    alias = alias.replace(/\@\-|\-\@|\@/gi, '');
    //In alias ra textbox có id “alias”
    document.getElementById('param_alias').value = alias;
}
